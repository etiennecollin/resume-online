...
pub fn Sidebar() -> impl IntoView {
    let title = "<h1 class=\"text-5xl font-semibold text-light-900 dark:text-dark-100\">Hi, im Etienne</h1>";
    let subtitle = "<h2 class=\"pt-2 text-xl text-light-900 dark:text-dark-100\">Student & Schulich Leader</h2>";
    let contact = "<a class=\"text-light-800 dark:text-dark-200 no-underline hover:underline\" href=\"mailto:collin.etienne.contact@gmail.com\">collin.etienne.contact@gmail.com</a>";
    let description =
        "<p class=\"pt-2 grow text-light-800 dark:text-dark-200\">Built with love using Rust 🦀 and NeoVim 🖥️</p>";
